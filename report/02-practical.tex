...
Таким образом, система объединяет простую структуру базы знаний и набор процедур вывода, что позволяет эффективно подбирать сорта пива по заданным пользователем критериям.
